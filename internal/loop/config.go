...
# Managed Claude Code lifecycle hook settings. Re-run cc-loop install after changing these.
[hooks]
...
# Optional command executed inside cc-loop before each automatic continuation.
[pre_loop_continue]
command = ""
cwd = "session_cwd"
timeout_seconds = 60
...
const projectRuntimeConfigFilename = "cc-loop.toml"
